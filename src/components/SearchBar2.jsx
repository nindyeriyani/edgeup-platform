...
export default function SearchBar() {
  ...
  const history = ["Data Analyst", "Cloud Computing", "Artifical Intelegence", "Product Designer", "Digital Marketing"]; // contoh history
  ...
  return (
    <div className="w-[864px] relative " ref={ref}>
      <div className="flex items-center border border-[#ACB7C6] rounded-[8px] bg-white px-4 py-3 gap-2" onClick={() => setShowHistory(true)} >
        <input
          type="text"
          value={query}
        ...
        />
        <Search className="w-5 h-5 text-gray-500 cursor-pointer" onClick={handleSearch} />
      </div>
