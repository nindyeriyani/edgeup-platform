...
export default function CareerCard({ title, name, role, company, date, desc, image }) {
  return (
    <div className="w-full max-w-[339px] h-auto min-h-[306px] bg-white rounded-xl p-5 flex flex-col font-['Nunito_Sans'] shadow-md border border-[#FFF4E4]" >
      {/* Title */}
      ...
      {/* Description */}
      <p className="font-normal text-sm leading-[140%] text-[#000000B2]  mb-4 line-clamp-3">{desc}</p>

      {/* Footer */}
      <div className="mt-auto flex flex-col">
        <p className="font-medium text-xs text-[#303B45] mb-2">{date}</p>
        <div className="w-full"> {/* Kontrol lebar tombol */}
            <Button>
            Baca Cerita {/* Otomatis ke tengah */}
            </Button>
        </div>
    </div>
